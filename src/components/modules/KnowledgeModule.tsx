            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-5 custom-scrollbar text-xs">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 font-medium focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-[#EA3A20] cursor-pointer"
                >
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-5 custom-scrollbar text-xs">
              ...
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-slate-800 font-medium focus:outline-none focus:ring-2 focus:ring-red-500/20 focus:border-[#EA3A20] cursor-pointer text-xs"
                >
                  {allCategoryPaths.map((c) => (
                    <option key={c.id} value={c.fullPath}>
                      {c.fullPath}
